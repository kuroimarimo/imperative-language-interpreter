...
enum adressCode {
	...
	OP_CREATE_VAR,			// create variable of type *(int*)input1 at *tVarCoordinates output
	OP_CREATE_FRAME,		// create variable frame of size *(int*)input1
	OP_SET_TOP_TO_BASE,		// changes the top frame to the base frame
	OP_DISPOSE_FRAME,		// dispose the frame at the top of the framestack
	...
	OP_BUILT_IN,			// calls built in function of type input1
